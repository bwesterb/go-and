...
// func andNotNEON(dst *byte, a *byte, b *byte, l uint64)
TEXT ·andNotNEON(SB), NOSPLIT, $0-32
    MOVD dst+0(FP), R0
    MOVD a+8(FP), R1
    MOVD b+16(FP), R2
    MOVD l+24(FP), R3
...
loop:
    ...
    VEOR  V1.B16, V16.B16,  V1.B16
    VEOR  V2.B16, V16.B16,  V2.B16
    VEOR  V3.B16, V16.B16,  V3.B16
...
// func xorNEON(dst *byte, a *byte, b *byte, l uint64)
TEXT ·xorNEON(SB), NOSPLIT, $0-32
    MOVD dst+0(FP), R0
    MOVD a+8(FP), R1
    MOVD b+16(FP), R2
    MOVD l+24(FP), R3
